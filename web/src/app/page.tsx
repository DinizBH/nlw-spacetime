      ...
      <main className="grid grid-cols-2 min-h-screen">
        ...
        <div className="flex flex-col justify-between px-28 p-16 bg-[url(../assets/bg-stars.svg)] bg-cover relative border-r border-white/10  overflow-hidden">
          ...
          <a href="" className="flex items-center gap-3 text-left hover:text-gray-50 transition-colors">
            ...
            <p className="text-sm leading-snug max-w-[140px]"><span className="underline"></span>Crie sua conta e salve suas memórias!</p>
          </a>
          {/* Hero */}
          <div className="space-y-5">
            ...
            <div className="max-w-[420px] space-y-1">
              ...
              <p className="text-lg leading-relaxed">Colecione momentos marcantes da sua jornada e compartilhe (se quiser) com todo mundo!</p>
            </div>
            <a className="inline-block rounded-full bg-green-500 px-5 py-2 font-alt text-sm uppercase leading-none text-black hover:bg-green-600" href="">CADASTRAR LEMBRANÇA</a>
          </div>
          {/* Copyright */}
          <div className="text-sm leading-relaxed text-gray-200">
            Feito com 💜 no NLW da{' '}
            <a href="https://rocketseat.com.br" target="_blank" rel="noopener noreferrer" className="underline hover:text-gray-100">Rocketseat</a>
          </div>
        </div>
        {/* Right */}
